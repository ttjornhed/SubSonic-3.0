    	...
    	public static IEnumerable<T> ToEnumerable<T>(this IDataReader rdr, List<string> columnNames, Func<DbDataReader, T> projector, Func<object, object> onItemCreated)
          ...
          FieldInfo[] cachedFields = null;
              ...
              result.Add(instance);
                    ...
                    //{
                    //  if(cachedProps == null)
                    //    cachedProps = typeof(T).GetProperties();
                    //  if(cachedFields == null)
                    //    cachedFields = typeof(T).GetFields();

                    //  Load(rdr, instance, columnNames, cachedProps, cachedFields);//mike added ColumnNames
                    //}
                    //catch
                    //{
                    ...
                    //  }
                    //  else //do we have a parameterless constructor?
                    //  {
                    //    throw;
                    //  }
                    //}
                    ...
                    else
                    {
                      ...
                      Load(rdr, instance, columnNames, null, null);//mike added ColumnNames
                    }
                    #endregion
